...
The first term we need to know when using git is a **repository**: 
  * This is a collection of files in a folder or directory related to your project, in which you create and save new code or content. It can be located on GitHub or locally on your computer. It contains the changelog of your project with commits, branches, tags etc.
