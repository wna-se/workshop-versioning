...
>
> **This tutorial avoids using the command line.** Instead, we will practice the basics of Git using Git in RStudio. Later on we will also introduce GitHub and show an example of the synchronization between the local git repository and the remote GitHub repository. In many cases, this is enough. Git in Rstudio and GitHub provide collaboration tools to all kinds of projects, and there are all kinds of good ways to use it.
>
...
>
> Let us start with a small excercise to get you activated. Which of these issues can you relate to?
> 
> * I have eight versions of this file - which one do I use?
> * I can’t remake this figure from last year - I don't remember how I did it
...
(13 min teaching) [fair-bio-practice](https://carpentries-incubator.github.io/fair-bio-practice/11-version-control/index.html#how-version-control-systems-work)
