...
<!-- skip forks, network graph, etc? If so figs commits-and-branches.png commits-snapshots.png and history-demo.png can be deleted-->
...
>> 1. No, Git started out as a software versioning control system, but can track a lot of other typdes of data as well.
