...
---
<!-- En ide': Ha en övning där man har scenariot att deet redan finns en folder man vill skapa ett github repo av, lokalt. T ex en av foldrarna med data som vi laddat ned inför kursen. Hur man går tillväga att lokalt via app skapa ett repo, flytta över/kopiera från sin download-/desktop-folder över till github-folder commita och kolla hur det ser ut remote. -->
___
