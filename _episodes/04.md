...
<!-- should there be an answer to the discussion? -->
...
---
<!-- branch protection likely needs update, but not sure what is advisable; new image needed; take help from someone -->
...
## (Optional) Step 3: Submit a small change via the web interface as external contributor
