...
![form](../fig/creating-using-web/form-2.png)
...
![created](../fig/creating-using-web/created-2.png)
...
![new-file-buttons](../fig/creating-using-web/new-file-buttons-2.png)
...
![new-file-editor](../fig/creating-using-web/new-file-editor-2.png)

Click on **Commit changes**, then add a commit message and click on **Commit changes** (save):

![new-file-commit](../fig/creating-using-web/new-file-commit-2.png)
...
![edit-file-preview](../fig/creating-using-web/edit-file-preview-2.png)
...
![commits-browse](../fig/creating-using-web/commits-browse-2.png)

In my example I got:

![commits-example](../fig/creating-using-web/commits-example-2.png)
...
- Create a new branch named `experiment`:
  ...
  ![create-branch](../fig/creating-using-web/create-branch-2.png)
...
- Make sure you commit to the new branch:
  ![commit-experiment-branch](../fig/creating-using-web/commit-experiment-branch-2.png)
...
![network](../fig/creating-using-web/network-2.png)
...
![choosealicense](../fig/creating-using-web/choosealicense-2.png)
...
![branches-click](../fig/creating-using-web/branches-click-2.png)

Now to initiate a merge (request), click on "New pull request":
![branches-overview](../fig/creating-using-web/branches-overview-2.png)
